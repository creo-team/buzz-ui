...
// import { SidebarNav } from '@creo-team/buzz-ui/client' // Temporarily disabled due to React type conflicts
import { SidebarNavWrapper } from '../../../components/sidebar-nav-wrapper'

// Temporary placeholder component
const SidebarNav = ({ ...props }: any) => (
	<div className="p-4 bg-yellow-100 border border-yellow-300 rounded-lg">
		<p className="text-yellow-800 text-sm">SidebarNav temporarily disabled due to React 19 type conflicts</p>
	</div>
)
...
export default function SidebarNavDocs() {
	const exampleItems = [
		...
		{ key: 'dashboard', label: 'Dashboard', href: '#dashboard', badge: '3' },
		{ key: 'users', label: 'Users', href: '#users' },
		{ key: 'documents', label: 'Documents', href: '#documents' },
		{ key: 'calendar', label: 'Calendar', href: '#calendar' },
		{ key: 'messages', label: 'Messages', href: '#messages', badge: 'New' },

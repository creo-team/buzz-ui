...
import { Card, Tabs, TabPanel } from '@creo-team/buzz-ui/client'
...
export default function TabsDocs() {
	...
	const iconItems = [
		{ key: 'home', label: 'Home' },
		{ key: 'users', label: 'Users', badge: 12 },
	...
	return (
		<div className="mx-auto max-w-6xl px-4 py-12">
			...
			<Card variant="elevated" className="mt-4">
				...
				<div className="mt-6">
					<CodeBlock code={`import { Tabs, TabPanel } from '@creo-team/buzz-ui/client'
...
<Tabs items={items} value={tab} onChange={setTab} variant="underline" fullWidth />`} />
			...
			<Card variant="elevated" className="mt-4">
				...
				<div className="mt-6">
					<CodeBlock code={`import { Button as BuzzButton } from '@creo-team/buzz-ui/client'

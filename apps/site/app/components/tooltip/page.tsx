"use client"
import { Button as BuzzButton, Tooltip } from '@creo-team/buzz-ui/client'
				...
				<div className="space-y-6">
					<div>
						...
						<div className="flex flex-wrap gap-3">
							<Tooltip content="Top tooltip" placement="top"><BuzzButton variant="text">Top</BuzzButton></Tooltip>
							<Tooltip content="Right tooltip" placement="right"><BuzzButton variant="text">Right</BuzzButton></Tooltip>
							<Tooltip content="Bottom tooltip" placement="bottom"><BuzzButton variant="text">Bottom</BuzzButton></Tooltip>
							<Tooltip content="Left tooltip" placement="left"><BuzzButton variant="text">Left</BuzzButton></Tooltip>
						</div>
					</div>
					...
					<div>
						...
						<div className="flex flex-wrap gap-3">
							<Tooltip content="Small tooltip" size="sm"><BuzzButton variant="outline" size="sm">Small</BuzzButton></Tooltip>
							<Tooltip content="Medium tooltip" size="md"><BuzzButton variant="outline">Medium</BuzzButton></Tooltip>
							<Tooltip content="Large tooltip with more content" size="lg"><BuzzButton variant="outline" size="lg">Large</BuzzButton></Tooltip>
							<Tooltip 
								...
								delayMs={200}
							>
								<BuzzButton variant="subtle" size="lg">Extra Large</BuzzButton>
							</Tooltip>
						</div>
					</div>
					...
					<div>
						...
						<div className="flex flex-wrap gap-3">
							<Tooltip content="Quick tooltip" delayMs={100}><BuzzButton variant="subtle">Fast (100ms)</BuzzButton></Tooltip>
							<Tooltip content="Standard tooltip" delayMs={500}><BuzzButton variant="subtle">Standard (500ms)</BuzzButton></Tooltip>
							<Tooltip content="Slow tooltip" delayMs={1000}><BuzzButton variant="subtle">Slow (1000ms)</BuzzButton></Tooltip>
						</div>
					</div>
					...
					<div>
						...
						<div className="flex flex-wrap gap-3">
							...
							>
								<BuzzButton variant="outline">Bouncy</BuzzButton>
							</Tooltip>
							<Tooltip 
							...
							>
								<BuzzButton variant="outline">Slide</BuzzButton>
							</Tooltip>
							<Tooltip 
							...
							>
								<BuzzButton variant="outline">Fade</BuzzButton>
							</Tooltip>
						</div>
					</div>
				</div>

...
const componentItems = [
	...
	{ key: 'checkbox', label: 'Checkbox', href: '/components/forms' },
	{ key: 'chip', label: 'Chip', href: '/components/chip' },
	{ key: 'code-box', label: 'Code Box', href: '/components/code-box' },
	{ key: 'combobox', label: 'Combobox', href: '/components/combobox', badge: 'New' },
	...
	{ key: 'fab', label: 'Fab', href: '/components/fab', badge: 'New' },
	...
	{ key: 'popover', label: 'Popover', href: '/components/popover', badge: 'New' },
	{ key: 'primitives', label: 'Primitives', href: '/components/primitives', badge: 'New' },
	{ key: 'progress', label: 'Progress', href: '/components/progress' },
	{ key: 'select', label: 'Select', href: '/components/select' },
	{ key: 'slider', label: 'Slider', href: '/components/slider', badge: 'New' },
